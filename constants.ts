...
export const PREDEFINED_MODELS: ModelSpec[] = [
  ...
  { name: 'Kimi K2', params_b: 1000, active_params_b: 32, precision_b: 2, hidden_size: 7168, num_layers: 61 },
];

export const GPU_CATALOG: GpuSpec[] = [
  { model: 'A10', tops_8bit: 250, vram_gb: 24, bw_gbps: 600, price_eur: 2700 },
  { model: 'A30', tops_8bit: 330, vram_gb: 24, bw_gbps: 933, price_eur: 4559 },
  { model: 'L40', tops_8bit: 362, vram_gb: 48, bw_gbps: 864, price_eur: 10300 },
  { model: 'L40s', tops_8bit: 733, vram_gb: 48, bw_gbps: 864, price_eur: 10860 },
  { model: 'A100 40 GB PCIe', tops_8bit: 624, vram_gb: 40, bw_gbps: 1555, price_eur: 11979 },
  { model: 'A100 40 GB SXM', tops_8bit: 624, vram_gb: 40, bw_gbps: 1555, price_eur: 18750 },
  { model: 'A100 80 GB PCIe', tops_8bit: 624, vram_gb: 80, bw_gbps: 1935, price_eur: 11000 },
  { model: 'A100 80 GB SXM', tops_8bit: 624, vram_gb: 80, bw_gbps: 2039, price_eur: 20350 },
  { model: 'H100 PCIe', tops_8bit: 1513, vram_gb: 80, bw_gbps: 2000, price_eur: 27300 },
  { model: 'H100 SXM', tops_8bit: 1979, vram_gb: 80, bw_gbps: 3350, price_eur: 27300 },
  { model: 'H100 NVL', tops_8bit: 1670, vram_gb: 188, bw_gbps: 3900, price_eur: 28700 },
];
